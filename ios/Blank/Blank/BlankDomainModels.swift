...
struct ControlForecast: Equatable {
    var title: String
...
enum DigitalWellnessAI {
    ...
    static func v3System(
        ...
        let forecast = controlForecast(profile: profile, plan: plan, now: now)
    ...
    private static func controlForecast(
        profile: DigitalWellnessV3Profile,
    ...
    private static func weeklyInsight(profile: DigitalWellnessV3Profile, forecast: ControlForecast) -> String {
