...
const ALLOWED_EVENTS = new Set([
  ...
  "wearable_data_stale",
  "wearable_recommendation_generated",
  "wearable_recommendation_accepted",
  "wearable_recommendation_ignored",
  "recovery_mode_started",
  "sleep_boundary_applied",
  ...
  "assistant_channel_preference_set",
  "assistant_proactive_delivered",
  "assistant_proactive_delivery_skipped",
  "setup_step_viewed",
  "setup_completed",
  "nfc_tag_registered",
  "nfc_wrong_tag",
